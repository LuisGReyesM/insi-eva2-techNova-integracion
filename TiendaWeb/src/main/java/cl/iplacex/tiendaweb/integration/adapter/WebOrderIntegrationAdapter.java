...
/**
 * Adaptador de Integración encargado de orquestar la conversión entre
 * el contexto web de Spring y el formato de intercambio XML para mensajería.
 */
public class WebOrderIntegrationAdapter {
    ...
    // Productor JMS dedicado a enviar la orden serializada a la cola
    private final WebOrderJmsProducer producer = new WebOrderJmsProducer();

    /**
     * Procesa la información del pedido actual, la serializa a XML y la publica en ActiveMQ.
     * @param order Objeto DTO base para la construcción del mensaje.
     */
